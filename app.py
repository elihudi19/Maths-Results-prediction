...
*Fail Grade in NECTA is only F which is termed as 0*
    ...
    st.write(f"**Intercept:** {intercept:.4f} This means the probability to pass is starting 0.107 when all variable is zero. But in real world enterpretation teacher to student ratio can never be zero"),
    st.markdown("---")
